            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="level4" class="form-control" placeholder="Masukkan Level4">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Discount + Add Discount %</strong>
                        <input type="text" name="diskon" class="form-control" placeholder="Masukkan Diskon + Add Disount %">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
