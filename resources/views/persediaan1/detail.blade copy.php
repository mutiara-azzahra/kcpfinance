                                ...
                                <div class="col-lg-12">  
                                    ...
                                    <tbody>
                                        ...
                                        @if ($sumQtyTerjual == 0)
                                            ...
                                            @foreach ($detailPersediaan as $j)
                                            <tr>
                                                <td> Pembelian {{ $j['billingDocument_date'] }}</td>
                                                <td> {{ $j['part_no'] }}</td>
                                                <td class="text-right"> {{ $j['qty'] }}</td>
                                                <td class="text-right"> {{  number_format($j['amount_ex_disc'], 0, ',', '.') }}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan='2' class="text-center">Total Persediaan</td>
                                        ...
                                        @elseif ($sumQtyTerjual < $qtyPersediaan) 
                                            @foreach ($persediaanAwal as $p)
                                            <tr>
                                                <td> Persediaan Akhir</td>
                                                <td>{{ $p->part_no }}</td>
                                                <td class="text-right">{{ $qtyPembelian }}</td>
                                                <td class="text-right">{{ number_format($hargaFinalPersediaan, 0, ',', '.') }}</td> 
                                            </tr>
                                            @endforeach
                                            @foreach ($detailPersediaan as $j)
                                            <tr>
                                                <td> Pembelian {{ $j['crea_date'] }}</td>
                                                <td> {{ $j['part_no'] }}</td>
                                                <td class="text-right"> {{ $j['qty'] }}</td>
                                                <td class="text-right"> {{  number_format($j['amount'], 0, ',', '.') }}</td>
                                            </tr>
                                            @endforeach
                                            @foreach ($detailRetur as $r)
                                            <tr>
                                            ...
                                            @endforeach
                                            <tr>
                                                <td colspan='2' class="text-center"><b>Total Persediaan Akhir</b></td>
                                                <td class="text-right"><b>{{ $totalPersediaanAkhir }}</b></td> 
                                                <td class="text-right"><b>{{  number_format($hargaPersediaanAkhir, 0, ',', '.')  }}</b></td>    
                                            </tr>
                                        @else 
                                            @foreach ($persediaanAwal as $p)
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan='2' class="text-center"><b>Total Persediaan Akhir</b></td>
                                                <td class="text-right"><b>{{ $sumQtyPersediaanAkhir }}</b></td> 
                                                <td class="text-right"><b>{{  number_format($sumAmountPersediaanAwal, 0, ',', '.')  }}</b></td>    
                                            </tr>
                                        @endif
                                    </tbody>
