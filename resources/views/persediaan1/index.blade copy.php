    ...
    <div class="col">
        <div class="card" style="padding: 20px;">
            <div class="col">
                    ...
                    <form action="{{ route('persediaan.getPersediaan') }}" method="POST">
                                {!! csrf_field() !!}
                        ...
                        <tbody>
                            <tr>
                                ...
                                @if($bulanPilih == '01' && $tahunPilih == '2023')
                                <td class="text-right">{{ number_format($sumTotalPersediaan, 0, ',', '.') }}</td>
                                @elseif($bulanPilih != '01' || $tahunPilih == '2023')
                                <td class="text-right">{{ number_format($persediaan_awal_index, 0, ',', '.') }}</td>
                                @endif
                            </tr>
